...
public class Sewing : Trait
{

    private void Awake()
    {
        TombstoneText.Add($"{Forename} loved repairing tattered clothing with their sewing kit.");
    }
    ...
    public override void OnUp()
    {
        ...
        if (head)
        {
            ...
            head.GetComponent<CorpseBodyPart>().ChangeAttribute((Attribute)2, 10); // Grace
        }
