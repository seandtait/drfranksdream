...
public class Teacher : Trait
{

    private void Awake()
    {
        TombstoneText.Add($"They will be missed by their pupils who look upto them.");
    }
    ...
    public override void OnUp()
    {
        ...
        if (brain)
        {
            ...
            brain.GetComponent<CorpseBodyPart>().ChangeAttribute((Attribute)1, 60); // Smarts
        }
